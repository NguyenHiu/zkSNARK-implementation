...
uint get_total_signal_no() {return 1486;}

uint get_number_of_components() {return 7;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 1465;}

uint get_size_of_constants() {return 192;}
...
uint csoffset = mySignalStart+7;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "mimcs1";
...
uint csoffset = mySignalStart+746;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "mimcs2";
MultiMiMC7_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 739 ;
aux_cmp_num += 3;
...
Fr_eq(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 2]); // line circom 28
...
Fr_lt(&expaux[0],&lvar[12],&circuitConstants[2]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[4],&circuitConstants[184],&signalValues[mySignalStart + 5]); // line circom 33
Fr_mul(&expaux[2],&signalValues[mySignalStart + 6],&expaux[4]); // line circom 33
Fr_add(&expaux[0],&signalValues[mySignalStart + 5],&expaux[2]); // line circom 33
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + 5],&circuitConstants[184]); // line circom 34
Fr_mul(&expaux[2],&signalValues[mySignalStart + 6],&expaux[4]); // line circom 34
Fr_add(&expaux[0],&circuitConstants[184],&expaux[2]); // line circom 34
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&signalValues[mySignalStart + 4]); // line circom 41
...
Fr_lt(&expaux[0],&lvar[12],&circuitConstants[2]); // line circom 45
while(Fr_isTrue(&expaux[0])){
...
PFrElement aux_dest = &lvar[13];
// load src
Fr_sub(&expaux[0],&lvar[12],&circuitConstants[2]); // line circom 47
// end load src
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[4],&lvar[13],&signalValues[mySignalStart + 5]); // line circom 47
Fr_mul(&expaux[2],&signalValues[mySignalStart + 6],&expaux[4]); // line circom 47
Fr_add(&expaux[0],&signalValues[mySignalStart + 5],&expaux[2]); // line circom 47
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &lvar[14];
// load src
Fr_sub(&expaux[0],&lvar[12],&circuitConstants[2]); // line circom 48
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 1)]].signalStart + 0]);
}
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + 5],&lvar[14]); // line circom 48
Fr_mul(&expaux[2],&signalValues[mySignalStart + 6],&expaux[4]); // line circom 48
Fr_add(&expaux[0],&lvar[15],&expaux[2]); // line circom 48
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&signalValues[mySignalStart + 3]); // line circom 55
